...
## 1. Request Parameters  
    ...
    Date Completed: 2025-12-19T03:17:34.130039  

    ID: 11cd94a8-4fec-4d58-a112-d8202d8ae70f  
    ...
    Details:  
        ...
        Layers:  
                ...
                _1_km_16_days_EVI (MOD13A2.061)  
                _1_km_16_days_NDVI (MOD13A2.061)  
                Geophysical_Data_surface_temp (SPL4SMGP.008)  
                Geophysical_Data_sm_rootzone_wetness (SPL4SMGP.008)  
                Geophysical_Data_land_evapotranspiration_flux (SPL4SMGP.008)  
                Geophysical_Data_sm_surface_wetness (SPL4SMGP.008)  
    ...
    Version: This request was processed by AppEEARS version 3.103  

## 2. Request File Listing  

**Supporting Files:**  

- 06-01-2021-MOD13A2-061-metadata.xml
- 06-01-2021-SPL4SMGP-008-metadata.xml
- 06-01-2021-granule-list.txt
- 06-01-2021-request.json
- MOD13A2-061-1-km-16-days-VI-Quality-lookup.csv
- MOD13A2-061-1-km-16-days-VI-Quality-Statistics-QA.csv
- MOD13A2-061-Statistics.csv
- SPL4SMGP-008-Statistics.csv

**Data Files:**  

Number of Extracted Data Files: 35  
Total Size of Extracted Data Files: 12.88 MB  
...
### 7.16.  NASA VIIRS Snow Products (Includes Suomi NPP & NOAA-20)
...
- Li. (2025). Climate change sensitivity. figshare. https://doi.org/10.6084/M9.FIGSHARE.30910928

Li. (2025). Climate change sensitivity (Version 1). figshare. https://doi.org/10.6084/M9.FIGSHARE.30910928.V1

Didan, K. (2021). MODIS/Terra Vegetation Indices 16-Day L3 Global 1km SIN Grid V061. NASA Land Processes Distributed Active Archive Center. https://doi.org/10.5067/MODIS/MOD13A2.061

Goldstein, B. R., Pacifici, K., Jensen, A. J., Reich, B. J., Cove, M. V., McShea, W. J., Rooney, B., Kierepka, E. M., Roberts, R. A., & Kays, R. (2025). Data inputs and results for "Mammal niches are not conserved over continental scales" by Goldstein et al. (Version v2.0). Zenodo. https://doi.org/10.5281/ZENODO.14219129

Goldstein, B. R., Pacifici, K., Jensen, A. J., Reich, B. J., Cove, M. V., McShea, W. J., Rooney, B., Kierepka, E. M., Roberts, R. A., & Kays, R. (2024). Data inputs and results for "Mammal niches are not conserved over continental scales" by Goldstein et al. (Version v1.0). Zenodo. https://doi.org/10.5281/ZENODO.14219130

Goldstein, B. R., Pacifici, K., Jensen, A. J., Reich, B. J., Cove, M. V., McShea, W. J., Rooney, B., Kierepka, E. M., Roberts, R. A., & Kays, R. (2025). Data inputs and results for "Mammal niches are not conserved over continental scales" by Goldstein et al. (Version v2.0). Zenodo. https://doi.org/10.5281/ZENODO.14680764

Xing, Z., Haoyan, Z., & Wei, W. (2023). Remote Sensing Drought Monitoring Dataset based Temperature Vegetation Precipitation Dryness Index (TVPDI) from 2001 to 2021 in China (v2.0) (Version 2.0). Zenodo. https://doi.org/10.5281/ZENODO.7762104

Xing, Z., Haoyan, Z., & Wei, W. (2023). Remote Sensing Drought Monitoring Dataset based Temperature Vegetation Precipitation Dryness Index (TVPDI) from 2001 to 2021 in China (v2.0) (Version 2.0). Zenodo. https://doi.org/10.5281/ZENODO.7762105

Xing, Z., Haoyan, Z., & Wei, W. (2022). Remote Sensing Drought Monitoring Dataset based Temperature Vegetation Precipitation Dryness Index (TVPDI) from 2001 to 2020 in China (Version 1.0). Zenodo. https://doi.org/10.5281/ZENODO.6615934

Xing, Z., Haoyan, Z., & Wei, W. (2022). Remote Sensing Drought Monitoring Dataset based Temperature Vegetation Precipitation Dryness Index (TVPDI) from 2001 to 2020 in China (Version 1.0). Zenodo. https://doi.org/10.5281/ZENODO.6615935. Accessed December 19, 2025.
- Reichle, R., De Lannoy, G., Koster, R., Crow, W., Kimball, J., Liu, Q., & Bechtold, M. (2025). SMAP L4 Global 3-hourly 9 km EASE-Grid Surface and Root Zone Soil Moisture Geophysical Data, Version 8. NASA National Snow and Ice Data Center Distributed Active Archive Center. https://doi.org/10.5067/T5RUATAQREF8. Accessed December 19, 2025.

## 10. Software Citation  

AppEEARS Team. (2025). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 3.103. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed December 19, 2025. https://appeears.earthdatacloud.nasa.gov
